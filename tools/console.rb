...
cary = Follower.new("Cary", 33, "Hey yall")
dave = Follower.new("Dave", 33, "Hey yall")
enes = Follower.new("Enes", 33, "Hey yall")
frank = Follower.new("Frank", 33, "Hey yall")
geoff = Follower.new("Geoff", 33, "Hey yall")
henry = Follower.new("Jill", 33, "Hey yall")
